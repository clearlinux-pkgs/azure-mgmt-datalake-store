...
License  : MIT
Requires: azure-mgmt-datalake-store-python = %{version}-%{release}
Requires: azure-mgmt-datalake-store-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-datalake-store package.
Group: Default
Requires: azure-mgmt-datalake-store-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-datalake-store package.


%package python3
Summary: python3 components for the azure-mgmt-datalake-store package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_datalake_store)
Requires: pypi(azure_common)
Requires: pypi(azure_mgmt_datalake_nspkg)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-datalake-store package.


%prep
%setup -q -n azure-mgmt-datalake-store-0.5.0
cd %{_builddir}/azure-mgmt-datalake-store-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588887128
...
rm -f %{buildroot}/usr/lib/python3.9/site-packages/samples/__init__.py
rm -f %{buildroot}/usr/lib/python3.9/site-packages/samples/__pycache__/__init__.cpython-38.pyc
rm -f %{buildroot}/usr/lib/python3.9/site-packages/azure/mgmt/datalake/__init__.py
rm -f %{buildroot}/usr/lib/python3.9/site-packages/azure/mgmt/datalake/__pycache__/__init__.cpython-38.pyc
